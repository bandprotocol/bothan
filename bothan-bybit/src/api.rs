...
//!
//! This module provides types and utilities for interacting with the Bybit WebSocket API,
...
//! - [`types`] — Message types used for communication with the Bybit WebSocket API.
//! - [`websocket`] — WebSocket client implementation for real-time data streaming.
//!
// ! # Integration with Workers
// !
// ! This module is intended to be used by worker implementations that subscribe to Bybit WebSocket streams for real-time updates.
