...
use crate::api::websocket::BybitWebSocketConnector;
...
/// A worker that fetches and stores the asset information from Bybit's API.
pub struct BybitWorker {
...
impl AssetWorker for BybitWorker {
